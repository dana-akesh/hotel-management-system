        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers("/api/v1/tasks/**").hasAnyRole(ADMIN.name(),CUSTOMER.name())
                                .requestMatchers(GET, "/api/v1/tasks/**").hasAnyAuthority(ADMIN_READ.name(), CUSTOMER_READ.name())
                                .requestMatchers(POST, "/api/v1/tasks/**").hasAnyAuthority(ADMIN_CREATE.name(),CUSTOMER_CREATE.name())
                                .requestMatchers(PUT, "/api/v1/tasks/**").hasAnyAuthority(ADMIN_UPDATE.name(),CUSTOMER_UPDATE.name())
                                .requestMatchers(DELETE, "/api/v1/tasks/**").hasAnyAuthority(ADMIN_DELETE.name(),CUSTOMER_DELETE.name())
